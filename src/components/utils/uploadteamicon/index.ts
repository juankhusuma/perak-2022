...
import { UploadTeamIconProps } from './interface'

export const uploadTeamIcon = async ({
  file,
  userId,
  onUploadProgress,
}: UploadTeamIconProps) => {
  ...
  const awsUrl = `https://perak2023.s3.ap-northeast-1.amazonaws.com/profilePhoto/${userId}/${file?.name}`
